...
const Login = () => {
    return (
        <Layout>
            <div className='container border-t-indigo-500 h-[500px] p-5 mt-10 flex flex-col justify-center login-form shadow-xl border-4 border-blue-50 rounded md:w-1/4 mx-auto'>
