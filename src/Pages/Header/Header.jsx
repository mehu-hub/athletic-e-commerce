            ...
            <Layout>
                <section className="container mx-auto mt-10">
                    <div className="md:w-1/4">
                        ...
                        <ul className="md:mt-5 mt-2 gap-2 categories md:grid-cols-1 grid grid-cols-2">

                            <Link className="flex items-center gap-2 bg-emerald-50	mt-2 rounded p-2">
                                <HiGift className="text-violet-400" />
                                <li>Trending</li>
                            </Link>
                            <Link className="flex mt-2 items-center gap-2 bg-emerald-50 rounded p-2">
